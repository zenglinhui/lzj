<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
    <form action="/zswin1.5/index.php/Admin/Node/insert/navTabId/<?php echo CONTROLLER_NAME;?>" id="j_custom_form" class="pageForm form-validate" method="post" callback="dialogAjaxDone" noEnter>
        ...
        <div class="pageFormContent form-horizontal" layoutH="60">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="text" class="form-control validate[required,custom[onlyLetterSp]] required" size="10" name="name" id="j_name" value=""  >
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control validate[required,custom[integer]] required" size="30" name="sort" id="j_sort" value="" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                <input type="text" class="form-control validate[custom[onlyLetterSp]]" size="10" name="remark" id="j_remark" value=""  >
