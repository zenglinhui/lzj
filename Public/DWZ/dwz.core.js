	...
	$.fn.extend({
		...
		layoutH: function($refBox){
			return this.each(function(){
				...
				if ($this.isTag("table")) {
					$this.removeAttr("layoutH").wrap('<div layoutH="'+iLayoutH+'" style="overflow:hidden;height:'+iH+'px"></div>');
				} else {
					$this.height(iH).css("overflow","hidden");

				}
				$this.niceScroll({styler:"fb",cursorcolor:"#ccc", cursorwidth: '3', cursorborderradius: '', background: '#404040', spacebarenabled:false, cursorborder: '', zindex: '1000'});
