...
(function($){
    $.fn.jTable = function(options) {
        return this.each(function() {
            ...
            thead.wrap('<div class="gridHeader"><div class="gridThead"><table class="table table-bordered" style="width:'+ (tlength - 6) + 'px;"></table></div></div>');
            ...
            ths.each(function(i){
                ...
                if ($th.attr('orderField')) {
                    ...
                    var $order = $('<a href="javascript:;" class="order"><span class="up" title="升序"><i class="icon-angle-up"></i></span><span class="down" title="降序"><i class="icon-angle-down"></i></span></a>');
            ...
            tbody.wrap('<div class="gridScroller"'+ layoutStr +' style="width:'+ $tc.width() +'px;"><div class="gridTbody"><table class="table table-hover table-bordered" style="width:'+ (tlength - 6) +'px; '+ gStyle +'" id="'+ gId +'"></table></div></div>');
